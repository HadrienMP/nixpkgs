...
let
  sources = {
    ...
    "rimraf-5.0.4" = {
      ...
      version = "5.0.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/rimraf/-/rimraf-5.0.4.tgz";
        sha512 = "rizQI/o/YAMM1us0Zyax0uRfIK39XR52EAjjOi0fzMolpGp0onj6CWzBAXuOx6+6Xi9Rgi0d9tUZojhJerLUmQ==";
      };
    };
    "ripemd160-2.0.2" = {
      name = "ripemd160";
